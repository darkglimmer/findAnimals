...
var questiones = {
    cat: [
        {
            content: '<size=24>嘘！猫猫们正在睡觉，选出正确的词猫猫可以继续睡觉，选择错误猫猫会惊醒大叫引来坏人哦！</size><br/><size=16> _________, but for you to tell your boss that he is cruel seems hard. </size>',
            answer: '3',
        },{
    ...
    dog: [
        {
            content: '<size=24>被偷走的狗狗有些害怕，一直在不停的叫，选对正确的俚语可以平复狗狗心情哦！</size><br/><size=16> If you want to be successful, you\'d better __________.  </size>',
            answer: '3',
        },{
    ...
    horse: [
        {
            content: '<size=24>快看！前面有三条路，选择正确的路能够更快解救到马儿哦！</size><br/><size=16>Robert is ____________ and I know he\'ll try his best to do all the work we give him.</size>',
            answer: '1',
        },{
    ...
    bird: [
        {
            content: '<size=24>你看到鸟儿了吗？他们被挂的真高！选择一个合适的梯子爬上去吧~</size><br/><size=16>Jack is ____________. He gets up around five o\'clock every morning.</size>',
            answer: '3',
        },{
    ...
    pig: [
        {
            content: '<size=24>啊!!!可恶的的小偷,竟然设置了陷阱,快选择一个合适的绳索爬上去吧!</size><br/><size=16>Would you like to ____________ tonight?</size>',
            answer: '2',
        },{
