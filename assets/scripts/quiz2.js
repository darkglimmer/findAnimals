...
var questiones = {
    cat: [
        {
            content: '<size=24>【选词填空】嘘！猫猫们正在睡觉，选出正确的词猫猫可以继续睡觉，选择错误猫猫会惊醒大叫引来坏人哦！</size><br/><size=22> _________, but for you to tell your boss that he is cruel seems hard. </size>',
            answer: '3',
            ...
            content: '<size=24>【补全俚语】小猫被关在了笼子里，补全俚语可以将猫猫解开哦！</size>',
            ...
            content: '<size=24>【连连看】小猫们饿的走不动了，不愿意和你走，快帮小猫们找到自己想吃的食物补充体力吧！(点击小喇叭听录音，并将猫粮与对应的小猫连线)</size>',
            answer: ['6','4','5'],
    ...
    dog: [
        {
            content: '<size=24>【选词填空】被偷走的狗狗有些害怕，一直在不停的叫，选对正确的俚语可以平复狗狗心情哦！</size><br/><size=22> If you want to be successful, you\'d better __________.  </size>',
            answer: '3',
            ...
            content: '<size=24>【补全俚语】狗狗终于安静下来了，现在快解开绳子带走狗狗吧！</size>',
            ...
            content:'<size=24>【连连看】可恶的小偷，竟然放出来蝙蝠阻止我解救狗狗，移动正确的武器来消灭围攻的蝙蝠吧（点击小喇叭听录音，并将相应的武器与蝙蝠连线）</size>',
            answer: ['4', '6', '5'],
    ...
    horse: [
        {
            content: '<size=24>【选词填空】快看！前面有三条路，选择正确的路能够更快解救到马儿哦！</size><br/><size=22>Robert is ____________ and I know he\'ll try his best to do all the work we give him.</size>',
            answer: '1',
            ...
            content: '<size=24>【补全俚语】走了这么久总算看到马儿了，咦！马儿身上怎么背着这么重的包袱，快帮他们取下来吧，在横线上补全俚语可以帮助马儿减轻包袱哦！</size>',
            ...
            content: '<size=24>【连连看】马儿们已经被关了太多天，饿的走不动了，快来帮助马儿们吃到他们想吃的草吧！选择错了马儿可不会跟你走哦~（点击小喇叭听录音，并将对应的草与马儿连线）</size>',
            answer: ['5', '6', '4'],
    ...
    bird: [
        {
            content: '<size=24>【选词填空】你看到鸟儿了吗？他们被挂的真高！选择一个合适的梯子爬上去吧~</size><br/><size=22>Jack is ____________. He gets up around five o\'clock every morning.</size>',
            answer: '3',
            ...
            content: '<size=24>【补全俚语】天哪，鸟儿们遭到了虐待，他们的翅膀在滴血，补全俚语可以得到纱布为鸟儿包扎，赶快开始吧！</size>',
            ...
            content: '<size=24>【连连看】鸟儿们好像都昏迷了，但是好像昏迷的原因不同，倾听他们的声音并选择合适的药水为他们治疗吧！（点击小喇叭听录音，并将药水与对应的鸟儿连线）</size>',
            answer: ['5', '6', '4'],
    ...
    pig: [
        {
            content: '<size=24>【选词填空】啊!可恶的的小偷,竟然设置了陷阱,快选择一个合适的绳索爬上去吧!</size><br/><size=22>Would you like to ____________ tonight?</size>',
            answer: '2',
            explain: '【题目·选词填空】\nWould you like to _________ tonight?\npigs might fly    pig out   pigs might fly\n【答案】\npig out\n【解析】\n图片中一个人在狼吞虎咽的吃着东西，因此推断此处应选“pig out”；\n原句意思为：你今天晚上想大吃一顿么？',
        },{
            content: '<size=24>【补全俚语】太可怜了,受到惊吓的小猪一直在哭泣,补全俚语可安慰小猪哦~</size>',
            ...
            content: '<size=24>【连连看】小猪们被锁住了,快将锁与钥匙配对,释放小猪吧!（点击小喇叭听录音，并将钥匙与相应的锁连线）</size>',
            answer: ['4','6','5'],
