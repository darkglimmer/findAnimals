...
cc.Class({
    ...
    controlActive: function(quizNum){
        this.quiz1 = (quizNum == 1);
        this.quiz2 = (quizNum == 2);
        this.quiz3 = (quizNum == 3);
    },
    ...
    updateQuiz1: function(quizContent){
        ...
        for(let i = 2; i <= 4; i++){
            this.quiz1.children[i].on(cc.Node.EventType.MOUSE_DOWN, this.clickQuiz1Option(1, i-1, quizContent), this);
        }
