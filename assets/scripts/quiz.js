...
var questiones = {
    'cat': [
        {
            content: '<size=20>嘘！猫猫们正在睡觉，选出正确的词猫猫可以继续睡觉，选择错误猫猫会惊醒大叫引来坏人哦！</size><br/><size=22>Failing to find a job, he is just like____________</size>',
            answer: '2',
    ...
    'dog': [
        {
            content: '<size=20>被偷走的狗狗有些害怕，一直在不停的叫，选对正确的俚语可以平复狗狗心情哦！</size><br/><size=22>Look, it begins to __________ outside! </size>',
            answer: '1',
    ...
    'horse': [
        {
            content: '<size=20>快看！前面有三条路，选择正确的路能够更快解救到马儿哦！</size><br/><size=22>Mr Green is always on his __________ ，so none of his colleagues like him.</size>',
            answer: '3',
    ...
    'bird': [
        {
            content: '<size=20>你看到鸟儿了吗？他们被挂的真高！选择一个合适的梯子爬上去吧~</size><br/><size=22>She ____________, No wonder she is so thin.</size>',
            answer: '2',
    ...
    'pig': [
        {
            content: '<size=20>啊!!!可恶的的小偷,竟然设置了陷阱,快选择一个合适的绳索爬上去吧!</size><br/><size=22>Hearing the boy ____________, his father woke up in the middle of the night.</size>',
            answer: '1',
